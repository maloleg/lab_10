...
COMPRESS      = gzip -9f
DISTNAME      = test1.0.0
DISTDIR = /home/oleg/test/.tmp/test1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1
...
distdir: FORCE
	...
	$(COPY_FILE) --parents class.h console.hpp $(DISTDIR)/
	$(COPY_FILE) --parents console.cpp main.cpp $(DISTDIR)/
...
moc_console.cpp: console.hpp \
		moc_predefs.h \
		/usr/lib/qt5/bin/moc
	/usr/lib/qt5/bin/moc $(DEFINES) --include /home/oleg/test/moc_predefs.h -I/usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++ -I/home/oleg/test -I/home/oleg/test -I/usr/include/x86_64-linux-gnu/qt5 -I/usr/include/x86_64-linux-gnu/qt5/QtGui -I/usr/include/x86_64-linux-gnu/qt5/QtCore -I/usr/include/c++/9 -I/usr/include/x86_64-linux-gnu/c++/9 -I/usr/include/c++/9/backward -I/usr/lib/gcc/x86_64-linux-gnu/9/include -I/usr/local/include -I/usr/include/x86_64-linux-gnu -I/usr/include console.hpp -o moc_console.cpp
