...
static const char qt_meta_stringdata_Console[] = {
    "Console\0\0Start()\0Stop()\0Exit()\0time\0"
    "TimerChange(uint64_t)\0Restart()\0"
...
void Console::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: _t->TimerChange((*reinterpret_cast< uint64_t(*)>(_a[1]))); break;
        case 4: _t->Restart(); break;
        case 5: _t->readCommand(); break;
        case 6: _t->SLOT_Start(); break;
        case 7: _t->SLOT_Stop(); break;
        case 8: _t->SLOT_Exit(); break;
        case 9: _t->SLOT_Timeout((*reinterpret_cast< uint64_t(*)>(_a[1]))); break;
        case 10: _t->SLOT_WhatToDo(); break;
        default: ;
        }
    }
}
